# Fakenews-Predictor<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
	<title>Fake News Predictor - Technical Workflow</title>
	<style>
		...
		.tech-stack { background: #eaf6fb; padding: 1em; border-radius: 6px; }
	</style>
</head>
<body>
	<h1>Fake News Predictor - Technical Workflow</h1>
